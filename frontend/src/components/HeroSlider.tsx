...
const slides = [
  { src: '/images/galeri-gagan-1.jpeg', alt: 'Turnamen Bola Voly Porduk 2026' },
  { src: '/images/galeri-gagan-2.jpeg', alt: 'Pertemuan Warga Padukuhan Gagan' },
  { src: '/images/galeri-gagan-3.jpeg', alt: 'Kerja Bakti Warga Padukuhan Gagan' },
]
